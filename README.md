...
This repository contains the official authors implementation associated with the paper "DARB-Splatting: Generalizing Splatting with Decaying Anisotropic Radial Basis Functions", which can be found [here](https://arxiv.org/abs/2501.12369). 
